...
- `selfecho_session/`：会话记忆层，保存 GUI 对话、周期摘要、会话搜索和历史回放。
...
- “陪我想想”是一种对话策略分支；项目整体目标是成熟的个人智能体。
...
selfecho_data/sessions.db       # IwIw 会话记忆数据库
...
- [演变计划评审与修订建议](docs/selfecho-evolution-plan-review.md)
- [DeepSeek、DualPath 与 oMLX 对 IwIw 智能体架构的启发](docs/deepseek-dualpath-omlx-agent-architecture.md)
