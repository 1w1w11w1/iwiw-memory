...
export declare const PLUGIN_NAME = "dsh-iwiw-memory";
/** 反思/dream 轮识别标记（与 host 端 reflect/dream 保持一致；当前未启用，预留）。 */
export declare const REFLECT_MARKER = "[iwiw-memory-reflect]";
export declare const DREAM_MARKER = "[iwiw-memory-dream]";
...
export declare function blocksToText(blocks: readonly {
    type?: string;
    text?: string;
}[]): string;
/**
 ...
 */
export declare function computeInjectionGroups(snapshot: ConversationSnapshotLike): InjectionGroup[];
